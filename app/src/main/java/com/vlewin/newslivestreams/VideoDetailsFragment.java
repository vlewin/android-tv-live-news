...
public class VideoDetailsFragment extends DetailsFragment {
    ...
    private static final int ACTION_WATCH_STREAM = 1;
    ...
    private void setupDetailsOverviewRow() {
        ...
        row.addAction(new Action(ACTION_WATCH_STREAM, getResources().getString(
                R.string.watch_stream)));
    ...
    private void setupDetailsOverviewRowPresenter() {
        ...
        detailsPresenter.setOnActionClickedListener(new OnActionClickedListener() {
            ...
            public void onActionClicked(Action action) {
                if (action.getId() == ACTION_WATCH_STREAM) {
                    Intent intent = new Intent(Intent.ACTION_VIEW);
                    intent.setDataAndType(Uri.parse(mSelectedMovie.getVideoUrl()), "video/*");
...
//                    startActivity(intent);
    ...
    private void setupMovieListRow() {
        ...
        for (int j = 0; j < NUM_COLS; j++) {
            ...
            if(mSelectedMovie.getId() != movie.getId()) {
